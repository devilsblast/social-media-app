      ...
      flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl">
        ...
        justify-center'>
          <div className="w-full flex gap-2 items-center mb-6">
            ...
            <span className='text-2xl text-[#065ad8] font-semibold'>Strings</span>
          </div>
          ...
          onSubmit={handleSubmit(onSubmit)}>
            ...
            <TextInput name="firstName" placeholder="Frist Name"
            label="First Name"
            type='text'
          ...
          { errMsg?.message && (<span className={`text-sm ${errMsg?.status =="failed" ? 
        ...
        <div className="hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue">
          <div className="relative w-full flex item-center justify-center">
            ...
            <div className="absolute flex items-center gap-1 bg-white right-10 py-2 px-5 rounded-full">
              <BsShare size={14}/>
            ...
            <div className="absolute flex items-center gap-1 bg-white left-9 bottom-1 py-2 px-5 rounded-full">
